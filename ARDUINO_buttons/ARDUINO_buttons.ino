...
#define BUTTON_DOWN_PIN 2 // pin for the button DOWN 
#define BUTTON_DOWN_LED 13 // pin for the LED for the button DOWN
#define BUTTON_LEFT_PIN 7 // pin for the button LEFT
#define BUTTON_LEFT_LED 13 // pin for the LED for the button LEFT
#define BUTTON_UP_PIN 6 // pin for the button UP
#define BUTTON_UP_LED 13 // pin for the LED for the button UP
#define BUTTON_RIGHT_PIN 4 // pin for the button RIGHT
#define BUTTON_RIGHT_LED 13 // pin for the LED for the button RIGHT
